...
public class Speaker extends Appliance{
    ...
    public Speaker(String name, double price, int powerConsumption, int numberOfSpeakers,
                    double frequencyRangeMin, double frequencyRangeMax, int cordLength) {
        super(name, price);
    ...
    public String toString() {
        return "Speakers\nName = " + name + ", Price = " + price + ", PowerConsumption = "
                + powerConsumption + ", NumberOfSpeakers = " + numberOfSpeakers
                + ", FrequencyRangeMin = " + frequencyRangeMin + ", FrequencyRangeMax = "
                + frequencyRangeMax + ", CordLength = " + cordLength;
    }
}
